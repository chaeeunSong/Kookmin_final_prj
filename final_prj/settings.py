...
SECRET_KEY = 'django-insecure-+b@v$g=)4u$91szc&=51!him^_05j+ft_qk-2bm=8wc2c_b3xj'
...
# 로그인 시 블로그앱으로 리다이렉트
LOGIN_REDIRECT_URL = reverse_lazy('blogapp:board')
LOGOUT_REDIRECT_URL = reverse_lazy('accountapp:login')
...
#MEDIA URL 설정 후. pip install pillow
MEDIA_URL = '/media/'
